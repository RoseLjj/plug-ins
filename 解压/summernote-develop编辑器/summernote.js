  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      image: {
        ...
        dragImageHere: '在这里拖动图像或文本',
        dropImage: '拖动图像或文本',
        selectFromFiles: '选择图片',
        maximumFileSize: '最大文件',
        maximumFileSizeError: '文件过大.',
        url: '图片URL地址',
        remove: '删除图片'
      },
      video: {
      ...
      help: {
        ...
        'formatH1': '设置当前段落为一级标题',
        'formatH2': '设置当前段落为二级标题',
        'formatH3': '设置当前段落为三级标题',
        'formatH4': '设置当前段落为四级标题',
        'formatH5': '设置当前段落为五级标题',
        'formatH6': '设置当前段落为六级标题',
